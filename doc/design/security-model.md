...
- [`action-dsl.md`](./action-dsl.md)：动作 DSL、执行 IR、opcode 白名单和审批绑定
- [`control-plane.md`](./control-plane.md)：请求、审批、编译、下发、执行、审计状态机
